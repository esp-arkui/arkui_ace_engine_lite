...
public:
     ...
     */
    static void SetStringProperty(JSIValue object, const char * const propName, const char *value, size_t size);
     ...
     * value returned should be released by caller with ReleaseValue when it won't be used any more
     */
    static JSIValue CreateString(const char * const str, size_t size);
     ...
     * value returned should be released with ReleaseString(char *&str) when it won't be used any more
     */
    static char *GetStringProperty(JSIValue object, const char * const propName, size_t &size);
     ...
     * value returned should be released with ReleaseString(char *&str) when it won't be used any more
     */
    static char *ValueToString(JSIValue value, size_t &size);
