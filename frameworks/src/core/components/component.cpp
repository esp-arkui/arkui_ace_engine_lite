...
bool Component::IsModifyPosition(uint16_t attrKeyId) const
{
...
bool Component::AdaptBoxSizing(uint16_t attrKeyId) const
{
    ...
    bool isNeedAlignedPosition = (attrKeyId == K_UNKNOWN ? true : IsModifyPosition(attrKeyId));
