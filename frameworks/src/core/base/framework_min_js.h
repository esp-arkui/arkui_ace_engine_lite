...
const char * const g_frameworkJSBuffer =
    ...
    "es.push(n))},i.prototype.unsubscribe=function(){var t=this._detaches;t&&(t.forEach((functi"
    "on(t){t()})),this._detaches=[])},o.of=function(t){return t&&e(t)?t.__ob__?t.__ob__:new o(t"
    "):t},o.is=function(t){return t&&t._hijacking},o.prototype.attach=function(t,e){if(void 0!="
    "=t&&e){this._obsMap||(this._obsMap={}),this._obsMap[t]||(this._obsMap[t]=new Set);var n=th"
    "is._obsMap[t];return n.add(e),function(){n.delete(e)}}},o.prototype.notify=function(t){voi"
    "d 0!==t&&this._obsMap&&this._obsMap[t]&&this._obsMap[t].forEach((function(t){return t.upda"
    "te()}))},o.prototype.setParent=function(t,e){this._parent=t,this._key=e},o.prototype.notif"
    "yParent=function(){this._parent&&this._parent.notify(this._key)};var r={PUSH:'push',POP:'p"
    "op',UNSHIFT:'unshift',SHIFT:'shift',SORT:'sort',SPLICE:'splice',REVERSE:'reverse'},s=Objec"
    "t.keys(r).map((function(t){return r[t]}));function c(t){if(!(this instanceof c))return new"
    " c(t);var e=this._vm=this;'[object Object]'===Object.prototype.toString.call(t)&&Object.ke"
    "ys(t).forEach((function(n){var i=t[n];'render'===n?e.$render=i:'data'===n?function(t,e){'f"
    "unction'==typeof e&&(e=e.call(t,t));Object.keys(e).forEach((function(n){return function(t,"
    "e,n){Object.defineProperty(t,n,{enumerable:!1,configurable:!0,get:function(){return e[n]},"
    "set:function(t){e[n]=t}})}(t,e,n)})),o.of(e)}(e,i):'styleSheet'===n?initStyleSheet(i):'fun"
    "ction'==typeof i&&(e[n]=i.bind(e))}))}return c.prototype.$watch=function(t,e,n){return new"
    " i(this,t,e,n)},c}));";
#endif
