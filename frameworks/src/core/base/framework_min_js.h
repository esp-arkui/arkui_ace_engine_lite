...
const char * const g_frameworkJSBuffer =
    ...
    ";var n=this._obsMap[t];return n.add(e),function(){n.delete(e)}}},o.prototype.notify=functi"
    "on(t){void 0!==t&&this._obsMap&&this._obsMap[t]&&this._obsMap[t].forEach((function(t){retu"
    "rn t.update()}))},o.prototype.setParent=function(t,e){this._parent=t,this._key=e},o.protot"
    "ype.notifyParent=function(){this._parent&&this._parent.notify(this._key)};var r={PUSH:'pus"
    "h',POP:'pop',UNSHIFT:'unshift',SHIFT:'shift',SORT:'sort',SPLICE:'splice',REVERSE:'reverse'"
    "},s=Object.keys(r).map((function(t){return r[t]}));function c(t){if(!(this instanceof c))r"
    "eturn new c(t);var e=this._vm=this;'[object Object]'===Object.prototype.toString.call(t)&&"
    "Object.keys(t).forEach((function(n){var i=t[n];'render'===n?e.$render=i:'data'===n?functio"
    "n(t,e){'function'==typeof e&&(e=e.call(t,t));Object.keys(e).forEach((function(n){return fu"
    "nction(t,e,n){Object.defineProperty(t,n,{enumerable:!1,configurable:!0,get:function(){retu"
    "rn e[n]},set:function(t){e[n]=t}})}(t,e,n)})),o.of(e)}(e,i):'styleSheet'===n?initStyleShee"
    "t(i):'function'==typeof i&&(e[n]=i.bind(e))}))}return c.prototype.$watch=function(t,e,n){r"
    "eturn new i(this,t,e,n)},c}));";
#endif
