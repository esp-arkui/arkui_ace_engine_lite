...
uint16_t EventUtil::InvokeCallback(JSValue vm, JSValue callback, JSValue event)
{
    ...
    uint16_t taskID = AsyncTaskManager::GetInstance().Dispatch(CallbackExecutor, static_cast<void *>(params));
