...
#if (defined(__LITEOS_M__) || (defined(OHOS_ACELITE_PRODUCT_WATCH) && (OHOS_ACELITE_PRODUCT_WATCH == 1)))
#include "los_task.h"
#endif
...
#if (defined(__LINUX__) || defined(__LITEOS_A__))
    lock_.Lock();
#elif (defined(__LITEOS_M__) || (defined(OHOS_ACELITE_PRODUCT_WATCH) && (OHOS_ACELITE_PRODUCT_WATCH == 1)))
    LOS_TaskLock();
#else
    (void)lock_;
#endif
