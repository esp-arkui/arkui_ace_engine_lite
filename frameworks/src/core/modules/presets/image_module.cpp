...
jerry_value_t ImageModule::OnLoadSetter(const jerry_value_t func, const jerry_value_t context, const jerry_value_t args[], const jerry_length_t argsNum)
{
    ImageModule* imageModel = nullptr;
    jerry_get_object_native_pointer(context, (void**)&imageModel, &gcCallback);
    if(imageModel == nullptr){
        return jerry_create_error(JERRY_ERROR_EVAL, reinterpret_cast<const jerry_char_t *>("get imageModel fail"));
    ...
    if(argsNum == 1 && jerry_value_is_function(args[0])){
        ...
        return jerry_create_error(JERRY_ERROR_EVAL, reinterpret_cast<const jerry_char_t *>("set imageModel onload arg fail"));

    }
    return UNDEFINED;
}

jerry_value_t ImageModule::OnLoadGetter(const jerry_value_t func, const jerry_value_t context, const jerry_value_t args[], const jerry_length_t argsNum)
{
    ImageModule* imageModel = nullptr;
    jerry_get_object_native_pointer(context, (void**)&imageModel, &gcCallback);
    if(imageModel == nullptr){
...
jerry_value_t ImageModule::OnErrorSetter(const jerry_value_t func, const jerry_value_t context, const jerry_value_t args[], const jerry_length_t argsNum)
{
    ImageModule* imageModel = nullptr;
    jerry_get_object_native_pointer(context, (void**)&imageModel, &gcCallback);
    if(imageModel == nullptr){
...
jerry_value_t ImageModule::OnErrorGetter(const jerry_value_t func, const jerry_value_t context, const jerry_value_t args[], const jerry_length_t argsNum)
{
    ImageModule* imageModel = nullptr;
    jerry_get_object_native_pointer(context, (void**)&imageModel, &gcCallback);
    if(imageModel == nullptr){
...
jerry_value_t ImageModule::OnSrcSetter(const jerry_value_t func, const jerry_value_t context, const jerry_value_t args[], const jerry_length_t argsNum)
{
    ImageModule* imageModel = nullptr;
    jerry_get_object_native_pointer(context, (void**)&imageModel, &gcCallback);
    if(imageModel == nullptr){
...
jerry_value_t ImageModule::OnSrcGetter(const jerry_value_t func, const jerry_value_t context, const jerry_value_t args[], const jerry_length_t argsNum)
{
    ImageModule* imageModel = nullptr;
    jerry_get_object_native_pointer(context, (void**)&imageModel, &gcCallback);
    if(imageModel == nullptr){
...
jerry_value_t ImageModule::OnHeightSetter(const jerry_value_t func, const jerry_value_t context, const jerry_value_t args[], const jerry_length_t argsNum)
{
    ImageModule* imageModel = nullptr;
    jerry_get_object_native_pointer(context, (void**)&imageModel, &gcCallback);
    if(imageModel == nullptr){
    ...
    if (argsNum < 1) {
        return jerry_create_error(JERRY_ERROR_EVAL, reinterpret_cast<const jerry_char_t *>("set height fail"));
    }
    imageModel->height_ = IntegerOf(args[0]);
    return UNDEFINED;
}

jerry_value_t ImageModule::OnHeightGetter(const jerry_value_t func, const jerry_value_t context, const jerry_value_t args[], const jerry_length_t argsNum)
{
    ImageModule* imageModel = nullptr;
    jerry_get_object_native_pointer(context, (void**)&imageModel, &gcCallback);
    if(imageModel == nullptr){
...
jerry_value_t ImageModule::OnWidthSetter(const jerry_value_t func, const jerry_value_t context, const jerry_value_t args[], const jerry_length_t argsNum)
{
    ImageModule* imageModel = nullptr;
    jerry_get_object_native_pointer(context, (void**)&imageModel, &gcCallback);
    if(imageModel == nullptr){
    ...
    if (argsNum < 1) {
        return jerry_create_error(JERRY_ERROR_EVAL, reinterpret_cast<const jerry_char_t *>("set width fail"));
    }
    imageModel->width_ = IntegerOf(args[0]);
    return UNDEFINED;
}

jerry_value_t ImageModule::OnWidthGetter(const jerry_value_t func, const jerry_value_t context, const jerry_value_t args[], const jerry_length_t argsNum)
{
    ImageModule* imageModel = nullptr;
    jerry_get_object_native_pointer(context, (void**)&imageModel, &gcCallback);
    if(imageModel == nullptr){
...
void ImageModule::OnCallBack(const jerry_value_t context,const ImageModule *imageModule,bool isSucess,const char* msg)
{
