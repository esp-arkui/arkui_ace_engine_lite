...
#if (defined(FEATURE_SUPPORT_HTTP) && FEATURE_SUPPORT_HTTP == 1)
extern void InitFetchModule(JSIValue exports);
#endif // FEATURE_SUPPORT_HTTP
#if (defined(FEATURE_MODULE_AUDIO) && FEATURE_MODULE_AUDIO == 1)
...
#if (defined(ENABLE_MODULE_CIPHER) && ENABLE_MODULE_CIPHER == 1)
extern void InitCipherModule(JSIValue exports);
#endif
#if (defined(FEATURE_MODULE_DIALOG) && FEATURE_MODULE_DIALOG == 1)
extern void InitDialogModule(JSIValue exports);
#endif // FEATURE_MODULE_DIALOG

#if (defined(FEATURE_MODULE_STORAGE) && FEATURE_MODULE_STORAGE == 1)
extern void InitNativeApiFs(JSIValue exports);
extern void InitNativeApiKv(JSIValue exports);
#endif

#if (defined(FEATURE_MODULE_DEVICE) && FEATURE_MODULE_DEVICE == 1)
extern void InitDeviceModule(JSIValue exports);
#endif

#if (defined(FEATURE_MODULE_GEO) && FEATURE_MODULE_GEO == 1)
extern void InitLocationModule(JSIValue exports);
#endif

#if (defined(FEATURE_MODULE_SENSOR) && FEATURE_MODULE_SENSOR == 1)
extern void InitVibratorModule(JSIValue exports);
extern void InitSensorModule(JSIValue exports);
#endif

#if (defined(FEATURE_MODULE_BRIGHTNESS) && FEATURE_MODULE_BRIGHTNESS == 1)
extern void InitBrightnessModule(JSIValue exports);
#endif

#if (defined(FEATURE_MODULE_BATTERY) && FEATURE_MODULE_BATTERY == 1)
extern void InitBatteryModule(JSIValue exports);
#endif

#if (defined(FEATURE_MODULE_CONFIGURATION) && FEATURE_MODULE_CONFIGURATION == 1)
extern void InitLocaleModule(JSIValue exports);
#endif

#if (defined(FEATURE_ACELITE_SYSTEM_CAPABILITY) && FEATURE_ACELITE_SYSTEM_CAPABILITY == 1)
extern void InitCapabilityModule(JSIValue exports);
#endif

#if (defined(ENABLE_MODULE_DM_LITE) && ENABLE_MODULE_DM_LITE == 1)
