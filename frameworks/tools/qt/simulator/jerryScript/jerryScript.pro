...
DEFINES += JERRY_ES2015_BUILTIN_DATAVIEW=0
DEFINES += JERRY_ES2015_BUILTIN_MAP=1
DEFINES += JERRY_ES2015_BUILTIN_SET=1
DEFINES += JERRY_ES2015_BUILTIN_WEAKMAP=0
DEFINES += JERRY_ES2015_BUILTIN_WEAKSET=0
DEFINES += JERRY_ES2015_BUILTIN_PROMISE=1
DEFINES += JERRY_ES2015_BUILTIN_PROXY=1
DEFINES += JERRY_ES2015_BUILTIN_REFLECT=0
DEFINES += JERRY_ES2015_BUILTIN_TYPEDARRAY=1
DEFINES += JERRY_ES2015_MODULE_SYSTEM=1
