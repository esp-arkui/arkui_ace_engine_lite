...
#ifndef ACE_ENGINE_LITE_FRAMEWORKS_NG_CORE_COMPONENTS_NG_EVENT_STATE_STYLE_MANAGER_H
#define ACE_ENGINE_LITE_FRAMEWORKS_NG_CORE_COMPONENTS_NG_EVENT_STATE_STYLE_MANAGER_H
#include <set>
